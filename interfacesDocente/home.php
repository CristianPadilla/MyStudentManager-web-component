...
if (isset($_POST['idCurso'])) {
    $sql = "SELECT * FROM curso WHERE id_curso =" . $_POST['idCurso'];
    $request = $mysqli->query($sql) or die($mysqli->error);
    $curso = $request->fetch_array(MYSQLI_ASSOC);
                ...
                <section class="full-box nav-lateral">
                    ...
                    <div class="full-box nav-lateral-content" id="sidebar-container">
                        ...
                        <nav class="full-box nav-lateral-menu">
                            <ul>
                                <li>
                                    <a href="home.php" class="active"><i class="fas fa-university fa-fw"></i> &nbsp;
                                        Inicio </a>
                                </li>
            ...
            <div class="pag-principal">
                <div class="w-100">
                    ...
                    <div id="content" class="contenedor-scroll">
                        ...
                        <section>
                            <div class="container; dentro">
                                ...
                                <div class="full-box tile-container">
                                    ...
                                    <a href="asistencias.php" class="tile">
                        ...
                        <img src="../img/teacher.gif" alt="" width="460" height="325" class="img-home"
